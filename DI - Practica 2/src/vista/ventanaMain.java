...
public class ventanaMain extends JFrame {
    ...
    public ventanaMain() {
        ...
        setSize(470, 500); // Tamaño de la ventana
        setLocationRelativeTo(null); // Con "null" hacemos que la ventana aparezca en el centro de la pantalla
        setDefaultCloseOperation(EXIT_ON_CLOSE); // Si clicamos en la "x" la ventana se cierra.
        setResizable(false); // Impedimos poder redimensionar la ventana.
        setTitle("CALCULADORA"); // Titulo de la ventana.
        setIconImage(Toolkit.getDefaultToolkit().getImage("src/vista/imagenes/Calculator-icon.png")); // Icono ventana.
        setLayout(null);  // Desactivamos la colocoacion de los componentes automaticamente.
        inicializar();  // Funcion que contiene los componentes de la ventana.
        setVisible(true);
    }
...
// Creamos una etiqueta y la posicionamos.
        ...
        etiquetaNum1.setBounds(100, 60, 80, 30);  // Posicionamos en la ventana.
        add(etiquetaNum1);
//Creamos una caja de texto donde introducir los numeros.
        num1 = new JTextField();
        num1.setBounds(200, 45, 120, 60);  // Posicionamos en la ventana.
        add(num1);
        num1.setBorder(null);
// Creamos una etiqueta y la posicionamos.
        etiquetaNum2 = new JLabel("Número 2: ");
        etiquetaNum2.setBounds(100, 140, 80, 30);  // Posicionamos en la ventana.
        add(etiquetaNum2);
//Creamos una caja de texto donde introducir los numeros.
        num2 = new JTextField();
        num2.setBounds(200, 125, 120, 60);  // Posicionamos en la ventana.
        add(num2);
        num2.setBorder(null);
//Creamos el boton "Suma". Este boton se mantiene a la espera de ser clicado.
        sumarBoton = new JButton("Sumar");
        sumarBoton.setBounds(100, 225, 120, 60);  // Posicionamos en la ventana.
        add(sumarBoton);
...
//Creamos el boton "Resta". Este boton se mantiene a la espera de ser clicado.
        ...
        restarBoton.setBounds(240, 225, 120, 60);  // Posicionamos en la ventana.
        add(restarBoton);
        restarBoton.addActionListener(new gestorEventos(this));
//Creamos el boton "Multiplicar". Este boton se mantiene a la espera de ser clicado.
        multiplicarBoton = new JButton("Multiplicar");
        multiplicarBoton.setBounds(100, 300, 120, 60);  // Posicionamos en la ventana.
        add(multiplicarBoton);
        multiplicarBoton.addActionListener(new gestorEventos(this));
//Creamos el boton "Dividir". Este boton se mantiene a la espera de ser clicado.
        dividirBoton = new JButton("Dividir");
        dividirBoton.setBounds(240, 300, 120, 60);  // Posicionamos en la ventana.
        add(dividirBoton);
        dividirBoton.addActionListener(new gestorEventos(this));
//Creamos la etiqueta de resultado
        etiquetaResultado = new JLabel("Resultado: ");
        etiquetaResultado.setBounds(100, 375, 80, 30);  // Posicionamos en la ventana.
        add(etiquetaResultado);
//Creamos el cajon de texto que mostrará el resultado.
        resultado = new JTextField();
        resultado.setBounds(200, 375, 160, 30);  // Posicionamos en la ventana.
